        ...
        <div
            ...
            >
                ...
                <div className={'col-span-9 flex flex-col items-start gap-4'}>
                    ...
                    <h1 className={'text-xl'}>Epóxi</h1>

                    <h5 className={'text-md md:text-sm'}>Durabilidade e sofisticação em um só acabamento. O revestimento
                        epóxi transforma pisos e superfícies, trazendo resistência, fácil manutenção e um visual moderno
                        para qualquer ambiente.</h5>
                </div>
