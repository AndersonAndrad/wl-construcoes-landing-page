...
export function RevestimentoPage() {
        ...
        <div
            ...
            >
                ...
                <div className={'col-span-9 flex flex-col items-start gap-4'}>
                    ...
                    <h1 className={'text-xl'}>Revestimento</h1>

                    <h5 className={'text-md md:text-sm'}>Acabamentos que fazem a diferença. Trabalhamos com uma
                        variedade de revestimentos para pisos e paredes, proporcionando estética, funcionalidade e
                        resistência para cada ambiente.</h5>
                </div>
