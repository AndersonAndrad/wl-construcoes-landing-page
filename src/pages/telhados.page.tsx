        ...
        <div
            ...
            >
                ...
                <div className={'col-span-9 flex flex-col items-start gap-4'}>
                    ...
                    <h1 className={'text-xl'}>Telhados</h1>

                    <h5 className={'text-md md:text-sm'}>Proteção e durabilidade são essenciais para qualquer
                        construção. Oferecemos instalação e manutenção de telhados com materiais resistentes, garantindo
                        conforto térmico e segurança para sua obra.</h5>
                </div>
