        ...
        <div
            ...
            >
                ...
                <div className={'col-span-9 flex flex-col items-start gap-4'}>
                    ...
                    <h1 className={'text-xl'}>Ferragens</h1>

                    <h5 className={'text-md md:text-sm'}>Fundamentais para a resistência e estabilidade da sua obra.
                        Trabalhamos com ferragens de alta qualidade, garantindo segurança e durabilidade para cada
                        projeto.</h5>
                </div>
