        ...
        <div
            ...
            >
                ...
                <div className={'col-span-9 flex flex-col items-start gap-4'}>
                    ...
                    <h1 className={'text-xl'}>Alvenaria</h1>

                    <h5 className={'text-md md:text-sm'}>A base sólida de qualquer construção. Nossa equipe
                        especializada executa serviços de alvenaria com precisão e qualidade, garantindo estruturas
                        seguras e bem acabadas.</h5>
                </div>
